...
const milestones = [
  { date: "Nov 10, 2022", title: "Awareness Session", description: "Awareness session for the research project and, we had to select a supervisor.", color: "bg-slate-600" },
  { date: "Jan 20, 2023", title: "Topic Evaluation", description: "In this stage the Topic we selected been evaluated.", color: "bg-yellow-400" },
  { date: "Mar 27, 2023", title: "Project Proposal Presentation", description: "A project proposal is prepared to make an offer and to try to convince a supervisor or a future customer to accept it.", color: "bg-pink-500" },
  { date: "May 22, 2023", title: "Progress Presentation 1", description: "In this stage we had to show our progress up to 50%.", color: "bg-blue-600" },
  { date: "Jun 20, 2023", title: "Research Paper", description: "Published research findings and methodology.", color: "bg-teal-500" },
  { date: "Sep 04, 2023", title: "Progress 2", description: "Demonstrated 90% progress.", color: "bg-green-500" },
  { date: "Oct 20, 2023", title: "Final Submission", description: "Finalized and submitted the project.", color: "bg-gray-700" },
];
  ...
  return (
    <section className="container mx-auto px-4 py-12">
      ...
      <p className="text-center text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mt-2">
        Track the key stages of our project journey.
      </p>
                      ...
                      <>
                        <div className="pr-12">
                          ...
                          <div className="bg-white dark:bg-gray-800 p-4 rounded-md shadow-md">
                            <h3 className="font-semibold text-gray-800 dark:text-white text-lg mb-2">{milestone.title}</h3>
